 ...
 */
public class StateFullTransformDriver {
  ...
  private static void consumeOutput(final String bootstrapServers) {
    ...
    consumer.subscribe(Collections.singleton(StateFulTransformExmp.SUM_OF_ODD_NUMBERS_TOPIC));
    while (true) {
  ...
  private static void produceInput(final String bootstrapServers) {
    ...
    IntStream.range(0, 100)
        .mapToObj(val -> new ProducerRecord<>(StateFulTransformExmp.NUMBERS_TOPIC, val, val))
